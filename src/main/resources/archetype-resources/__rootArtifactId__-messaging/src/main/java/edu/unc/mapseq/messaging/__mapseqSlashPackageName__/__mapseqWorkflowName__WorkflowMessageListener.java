...
public class ${mapseqWorkflowName}WorkflowMessageListener extends AbstractMessageListener {

    private final Logger logger = LoggerFactory.getLogger(${mapseqWorkflowName}WorkflowMessageListener.class);

    public ${mapseqWorkflowName}WorkflowMessageListener() {
        super();
    }
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            if (workflowList == null || (workflowList != null && workflowList.isEmpty())) {
                logger.error("No Workflow Found: {}", "${mapseqWorkflowName}");
                return;
            }
