...
@Command(scope = "${mapseqGroupName}", name = "run-workflow", description = "Run ${mapseqTitle} Workflow")
public class ${mapseqWorkflowName}RunWorkflowAction extends AbstractAction {
    ...
    public ${mapseqWorkflowName}RunWorkflowAction() {
        super();
    }
