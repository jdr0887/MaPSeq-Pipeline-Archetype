...
public class ${mapseqWorkflowName}Workflow extends AbstractSampleWorkflow {

    private final Logger logger = LoggerFactory.getLogger(${mapseqWorkflowName}Workflow.class);

    public ${mapseqWorkflowName}Workflow() {
        super();
    }

    @Override
    public String getName() {
        return ${mapseqWorkflowName}Workflow.class.getSimpleName().replace("Workflow", "");
    }
