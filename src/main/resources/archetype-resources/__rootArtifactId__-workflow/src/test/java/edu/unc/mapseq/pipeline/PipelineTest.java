...
public class PipelineTest {
    ...
    public void createDot() {
        ...
        // new job
        CondorJob helloJob = PipelineJobFactory.createJob(++count, EchoCLI.class, null);
        graph.addVertex(helloJob);

        // new job
        CondorJob worldJob = PipelineJobFactory.createJob(++count, EchoCLI.class, null);
        graph.addVertex(worldJob);

        // new job
        CondorJob catJob = PipelineJobFactory.createJob(++count, CatCLI.class, null);
